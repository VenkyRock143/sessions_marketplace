...
SECRET_KEY = env('DJANGO_SECRET_KEY', default='dev-key-change-in-production')
...
# No sslmode here — works with local Docker Postgres and Supabase.
# For Supabase add OPTIONS sslmode in your .env or production.py override.
DATABASES = {
    'default': {
...
# Stripe — safe to leave blank in development
